...
(7, 'Design a Logo', 'hourly', 'i want clean and fresh in eyes', 1, '2009-06-13 00:00:00', 11.39112220273, False, NULL, False, NULL, False, 0, False),
  ...
  (10, 'earn money-simple job', 'hourly', 'This is a very Easy project. I am looking for someone for an extremely simple job, All you have to do is to be clicking on certain links, but i will explain more to the person who I select.', 1, '2012-06-13 15:33:00', 24.344342222344623, True, '2015-07-01 00:00:00', True, '2015-08-21 00:00:00', False, 0, False),
  (11, 'Fixing Wordpress Errors', 'hourly', 'We recently had our Wordpress site upgraded (www.invincibletrick.com), however Ive had troubles with my developer and seem to now have a website with a range of small errors that are preventing certain things from happening. ', 1, '2014-06-13 14:55:00', 18.444335345, False, NULL, False, NULL, False, 0, False),
  (12, 'Design a YouTube Banner Minecraft Related', 'hourly', 'Hello artists and designers. I need your help to create a YouTube banner, that gives a cartoon feel but also is high quality. It will need some good artist skill, and is somewhat related around the video game Minecraft. I would prefer it to be a vector image with a ratio of 2120 x 351. I will give an example of a banner, but I would want mine to be different from the example', 1, '2011-06-13 12:33:00', 19.399993434530273, True, '2015-07-01 00:00:00', True, '2015-08-21 00:00:00', False, 0, False),
